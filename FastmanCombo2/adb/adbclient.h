...
public:
    ...
    bool adb_install(const QString& lpath, const QString &params, QString &hint);
    ...
    bool adb_push(const QString& lpath, const QString& rpath, QString &hint, int mode = 0644);
